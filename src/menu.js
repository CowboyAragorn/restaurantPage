...
export default function menuRender() {
    ...
    let subHeader = document.createElement('h2');
        ...
        let item1 = ['https://img.buzzfeed.com/buzzfeed-static/static/2016-02/21/17/campaign_images/webdr08/for-everyone-who-dips-their-fries-in-their-wendys-2-29065-1456093003-8_dblbig.jpg?resize=1200:*','Original Lard n\' Grease', '$2.00', 'Since 1972'];
        let item2 = ['https://i0.wp.com/post.healthline.com/wp-content/uploads/2018/10/Can-Certain-Foods-Give-You-Nightmares_1296x728-header.jpg?w=1155&h=1528','Goblin Burger', 'Combo $7.99', ['Solo $4.99']];
        let item3 = ['https://www.chicagotribune.com/resizer/TixVzrslh22JHi2u0HtuboOrD1w=/415x233/top/cloudfront-us-east-1.images.arcpublishing.com/tronc/FAHVXS3YTZEPLLP2CPSRG4MF3Q.jpg','The Foot-Lettuce', '$6.99'];
        let item4 = ['https://upload.wikimedia.org/wikipedia/commons/thumb/6/6d/Dinosaur_Chicken_Nuggets.jpg/1280px-Dinosaur_Chicken_Nuggets.jpg','Raptor Bites', '$6.99'];
        let item5 = ['https://eatup.kitchen/wp-content/uploads/2019/06/Salmon-Burger-Web-470.jpg','-OR THE WHALE (Salmon)', '$8.99'];
